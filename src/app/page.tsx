      ...
      <div className="mx-auto flex max-w-5xl flex-col gap-16 px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-2xl text-base text-neutral-600 sm:text-lg">
              From CAD file to manufacturing quote, without the runaround. One
              front door for quotes, DFM feedback, and supplier coordination.
            </p>
          </div>
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 text-sm">
              ...
              <p className="text-neutral-700">
                We review manufacturability, flag risks, and line up realistic
                paths to parts in hand.
              </p>
            </div>
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 text-sm">
              <div className="mb-2 text-xs font-semibold uppercase text-neutral-500">
        ...
        <section className="space-y-4">
          ...
          <p className="max-w-3xl text-sm text-neutral-700 sm:text-base">
            ...
            middle – getting from CAD to parts without losing context or time.
          </p>
        </section>
        ...
        <section id="upload" className="space-y-4">
          ...
          <p className="text-sm text-neutral-600 sm:text-base">
            Start with one file. We&apos;ll use this to tune the flow, not to
            spam you with sales outreach.
          </p>
          <UploadBox />
        </section>
