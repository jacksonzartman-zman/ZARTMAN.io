...
export function EmailCustomerForm(props: { quoteId: string; enabled: boolean; fileOptions: OutboundFileOption[] }) {
  ...
  const helpCopy = useMemo(() => {
    ...
    return "Send an email to the customer. If email replies are enabled for this quote, they can reply directly via email to respond.";
  }, [props.enabled]);
