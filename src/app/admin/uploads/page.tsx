...
type ResolvableSearchParams =
  | AdminUploadsPageProps["searchParams"]
  | URLSearchParams
  ...
  return (
    ...
    >
      ...
      <section className="mb-6 grid gap-3 text-sm sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
        ...
        />
        <MetricCard label="New today" value={metrics.newToday} hint="Created in last 24h" />
        <MetricCard
          label="Stale RFQs"
