...
export default async function CustomerNotificationsPage() {
  ...
  if (!roles?.isCustomer) {
    return (
      <PortalShell
        workspace="customer"
        title="Notifications"
        subtitle="You don’t have access to the customer workspace."
      >
        <section className="rounded-2xl border border-slate-900 bg-slate-950/40 p-6">
          <p className="text-sm text-slate-300">This page is only available to customer users.</p>
        </section>
      </PortalShell>
    );
  }
  ...
  return (
    <PortalShell
      workspace="customer"
      title="Notifications"
      subtitle="What needs your attention across quotes, messages, and kickoff."
      actions={
          ...
          <form action={markAllRead}>
            <button
              ...
              className={clsx(
                ...
                hasUnread
                  ? "border-emerald-400/40 text-emerald-100 hover:border-emerald-300 hover:text-white"
                ...
                {items.map((n) => (
                  <li
                    ...
                    className={clsx(
                      ...
                      n.isRead ? "border-slate-900/60" : "border-emerald-500/20",
                    )}
                  >
