    ...
    >
      <div className="space-y-6">
        {fileCount === 0 ? (
          ...
          <EmptyStateCard
            title="Kickoff starts after supplier selection"
          ...
          <section className="rounded-2xl border border-slate-900/60 bg-slate-950/30 px-5 py-4">
            <header className="flex flex-wrap items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-300">
                  Kickoff tracks final confirmations before ordering. This portal doesn’t place orders yet.
                </p>
              </div>
            </header>

            <dl className="mt-4 rounded-xl border border-slate-900/60 bg-slate-950/40 px-4 py-3 text-sm">
              ...
              <div className="grid grid-cols-[minmax(0,1fr),auto] items-baseline gap-x-3 border-t border-slate-900/60 pt-2">
                ...
                <dd className="break-anywhere text-xs text-slate-300">
                  {derived.targetDateValue ? formatDateTime(derived.targetDateValue) : "—"}
                </dd>
              </div>
            </dl>
