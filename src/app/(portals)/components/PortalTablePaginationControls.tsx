...
export type PortalTablePaginationControlsProps = {
  page: number;
  pageSize: number;
  hasMore: boolean;
  basePath: string;
...
export default function PortalTablePaginationControls({
  page,
  pageSize,
  hasMore,
  basePath,
  ...
  rowsOnPage,
  className,
}: PortalTablePaginationControlsProps) {
  ...
  const listState = listStateConfig ? parseListState(searchParams, listStateConfig) : null;
